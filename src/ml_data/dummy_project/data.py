...
def main():
    ...
    generate_fake_raw_dummy_data(path=RAW_DATA_DIR / f"data_{ENV_VAR_OUTPUT_SUFFIX}.csv")
    ...
    write(df=df_cleaned, path=CLEAN_DATA_DIR / f"data_{ENV_VAR_OUTPUT_SUFFIX}.csv")
